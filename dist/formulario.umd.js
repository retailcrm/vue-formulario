(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    __decorate([
        vuePropertyDecorator.Provide()
    ], FormularioForm.prototype, "path", void 0);
    __decorate([
        vuePropertyDecorator.Watch('formularioValue', { deep: true })
    ], FormularioForm.prototype, "onFormularioValueChanged", null);
    __decorate([
        vuePropertyDecorator.Watch('mergedFormErrors')
    ], FormularioForm.prototype, "onMergedFormErrorsChanged", null);
    __decorate([
        vuePropertyDecorator.Watch('mergedFieldErrors', { deep: true, immediate: true })
    ...
    __decorate([
        vuePropertyDecorator.Provide('formularioRegister')
    ], FormularioForm.prototype, "register", null);
    __decorate([
        vuePropertyDecorator.Provide('formularioDeregister')
    ], FormularioForm.prototype, "deregister", null);
    __decorate([
        vuePropertyDecorator.Provide('formularioSetter')
    ...
    __decorate([
        vuePropertyDecorator.Provide('path')
    ], FormularioGrouping.prototype, "groupPath", null);
    FormularioGrouping = __decorate([
        vuePropertyDecorator.Component({ name: 'FormularioGrouping' })
    ], FormularioGrouping);
    ...
    FormularioInput = __decorate([
        vuePropertyDecorator.Component({ name: 'FormularioInput', inheritAttrs: false })
    ], FormularioInput);
